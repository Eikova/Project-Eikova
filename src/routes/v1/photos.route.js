...
router.route('/').get(auth('download'), photoController.getPhotos);

router.route('/private').get(auth('fullPhotoAccess'), photoController.getPrivatePhotos);

router.route('/user-contributions/:userId').get(auth('managePhotos'), photoController.getContributions);
...
router.route('/:id/download').get(auth('download'), photoController.downloadPhoto);

router.route('/:id/replace').patch(auth('managePhotos'), upload.single('image'), photoController.replacePhoto);
...
router.route('/:id/toggle-privacy').patch(auth('fullPhotoAccess'), photoController.togglePhotoPrivacy);
